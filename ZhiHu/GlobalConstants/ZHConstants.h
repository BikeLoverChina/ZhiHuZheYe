...
#ifndef ZHConstants_h
#define ZHConstants_h
//-------------------获取设备大小-------------------------
//NavBar高度
...
#define IS_Above_IOS6 ([[[UIDevice currentDevice] systemVersion] floatValue] >= 6)
//是否大于等于7.0系统
#define IS_Above_IOS7 ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7)
#define IS_Above_IOS8 ([[[UIDevice currentDevice] systemVersion] floatValue] >= 8)
#define IS_Above_IOS9 ([[[UIDevice currentDevice] systemVersion] floatValue] >= 9)
...
//安全释放
#define ZH_RELEASE_SAFELY(__POINTER) __POINTER = nil;
